...
function TaskBody(props: TaskPanelProps & { detail?: boolean }) {
  ...
  return (
    <>
      ...
      {props.detail && task.error ? <SmartErrorDisplay error={task.error} style={{ marginTop: 16, marginBottom: 16 }} /> : null}
