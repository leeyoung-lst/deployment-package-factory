...
const STEP_FIELDS: Array<Array<keyof MicroserviceWizardValues>> = [["sourceEnv", "businessPlatform"], ["serviceKey", "serviceName", "description"], ["projectKind", "techStack", "microFrontendFramework"], ["port", "gitGroup", "imageNamespace"], ["middleware", "mcpServerEnabled", "k8sNamespace"], []];
