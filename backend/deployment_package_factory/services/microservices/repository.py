...
def _microservice_payload(
    ...
    return {
        ...
        "mcpTransport": result.mcp_transport,
        "mcpRequiresApiKey": result.mcp_requires_api_key,
        "mcpServiceUrl": result.mcp_service_url,
        "mcpAgentConfig": result.mcp_agent_config,
        "port": request.port,
