...
def render_install_ps1(installer_version: str, default_mode: str = "k8s") -> str:
    return (
        ...
        "    if ($image.sourceRef -and $image.targetRef -and $image.sourceRef -ne $image.targetRef) { & docker tag $image.sourceRef $image.targetRef }\n"
        "  }\n"
        ...
        "  $lines = & docker compose --env-file $envFile -f $composeFile ps --format json\n"
